...
<Callout emoji="⚠️">
  ...
  or see the <a href="https://www.npmjs.com/package/swc-minify-webpack-plugin">SWC Minify Webpack Plugin</a> which is
  a standalone tool if you only want minification.
</Callout>
...
If you set `jsc.minify.compress` to `true` or `{}`, SWC will preserve only license comments.
