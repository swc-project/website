...
Passing the AST to the JS Plugin system is a performance bottleneck. We recommend using the [WebAssembly interface](/docs/plugins/wasm).

</Callout>

You can create and use custom JavaScript plugins with SWC.
