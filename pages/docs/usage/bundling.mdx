...
<Callout emoji="🚧">
  This feature is still under construction. Also, the main author of SWC works for [Turbopack](https://github.com/vercel/turbo) by Vercel, so this feature is not a something that will be actively developed.
</Callout>
