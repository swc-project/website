...
<div className="mt-16 mb-20 text-center">
  [Get Started](/docs/getting-started) · [Playground](/playground) · [Blog](/blog/perf-swc-vs-babel) · [Rustdocs](https://rustdoc.swc.rs/swc/) · [GitHub Repository](https://github.com/swc-project/swc) · [Discord](https://discord.gg/GnHbXTdZz6) · [Donate](https://opencollective.com/swc)
</div>
...
Feel free to join the [discussions on GitHub](https://github.com/swc-project/swc/discussions)! Alternatively, you can join the [discussions on Discord](https://discord.gg/GnHbXTdZz6)!
