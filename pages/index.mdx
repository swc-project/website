...
SWC is an extensible Rust-based platform for the next generation of fast developer tools. It's used by tools like VSCode, Next.js, Parcel, and Deno, as well as companies like Microsoft, Vercel, ByteDance, Tencent, Shopify, and more.
...
<div className="flex h-6">
  ...
  <img alt="downloads" src="https://badgen.net/npm/dw/@swc/helpers" className="inline-block mr-2"/>
</div>
