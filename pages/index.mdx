...
SWC is an extensible Rust-based platform for the next generation of fast developer tools. It's used by tools like VSCode, Next.js, and Deno, as well as companies like Microsoft, Vercel, ByteDance, Shopify, and more.
