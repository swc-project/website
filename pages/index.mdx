...
<div className="mt-16 mb-20 text-center">
  [Get Started](/docs/getting-started) · [Playground](/playground) · [Blog](/blog) · [GitHub Repository](https://github.com/swc-project/swc) · [Donate](https://opencollective.com/swc)
</div>
