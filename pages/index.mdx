...
<div className="flex h-6">
  ...
  <img alt="downloads" src="https://badgen.net/npm/dw/@swc/core?label=npm%20downloads%20(@swc/core)" className="inline-block mr-2"/>
  <img alt="downloads" src="https://badgen.net/npm/dw/@swc/helpers?label=npm%20downloads%20(3rd%20party)" className="inline-block mr-2"/>
</div>
