...
<div className="mt-16 mb-20 text-center">
  [Get Started](/docs/getting-started) · [Playground](/playground) · [Blog](/blog/plugins) · [Rustdocs](https://rustdoc.swc.rs/swc/) · [GitHub Repository](https://github.com/swc-project/swc) · [Donate](https://opencollective.com/swc)
</div>
...
Follow [@swc_rs](https://twitter.com/swc_rs) and [@kdy1dev](https://twitter.com/kdy1dev) on Twitter for project updates.
