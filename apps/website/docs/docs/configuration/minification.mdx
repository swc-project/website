...
- [swcMinify with the Terser Webpack Plugin](https://webpack.js.org/plugins/terser-webpack-plugin/#swc)
- [SWC Minify Webpack Plugin](https://www.npmjs.com/package/swc-minify-webpack-plugin) which is a standalone tool if you only want minification.
