...
<Callout emoji="⚠️">
  This section is for people who want to use swc as a last step of the build
  process. If you want to use the swc minifier with a bundler, see the
  documentation for -{" "}
  <a href="https://webpack.js.org/plugins/terser-webpack-plugin/#swc">
    swcMinify with the Terser Webpack Plugin
  </a>
  - <a href="https://www.npmjs.com/package/swc-minify-webpack-plugin">
    SWC Minify Webpack Plugin
  </a> which is a standalone tool if you only want minification.
</Callout>
