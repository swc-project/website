...
<Callout emoji="⚠️">
  These [assumptions](https://babeljs.io/docs/assumptions) are made in loose
  mode by default, you might get unexpected reault if your code doesn't meet
  these assumptions. -
...
This is experimental because import attributes are not covered by ecmascript specifications yet.
...
Currently only transform plugin uses this. If not specified, SWC will create `.swc` directories.
...
Initial Stage 3 decorator.

- `"2023-11"`

TC39 decorator with proposal updates as of November 2023.
