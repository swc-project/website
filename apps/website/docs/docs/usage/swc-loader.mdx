...
<Tabs>
  <Tab label="pnpm">```bash pnpm i -D @swc/core swc-loader ```</Tab>
  <Tab label="npm">```bash npm i -D @swc/core swc-loader ```</Tab>
  <Tab label="yarn">```bash yarn add -D @swc/core swc-loader ```</Tab>
</Tabs>
