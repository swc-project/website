...
<Tabs>
  <Tab label="pnpm">```bash pnpm i -D jest @swc/core @swc/jest ```</Tab>
  <Tab label="npm">```bash npm i -D jest @swc/core @swc/jest ```</Tab>
  <Tab label="yarn">```bash yarn add -D jest @swc/core @swc/jest ```</Tab>
</Tabs>
